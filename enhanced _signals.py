...
class EnhancedSignalGenerator:
    ...
    def _load_model(self):
        try:
            ...
            print("⚠️ Model load failed - using fallback strategy")
            return None
    ...
    def _load_scaler(self):
        try:
            ...
            print("⚠️ Scaler load failed - using default scaling")
            return None
    ...
    def load_previous_day(self):
        ...
        for instrument in instruments[:5]:
            try:
                ...
                print(f"⚠️ Previous day load error for {instrument}: {str(e)}")
